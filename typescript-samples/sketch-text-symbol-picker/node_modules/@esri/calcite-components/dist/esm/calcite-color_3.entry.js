import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-8fd57462.js';
import { f as focusElement, g as getElementDir } from './dom-d9ba1da4.js';
import { n as normalizeHex, C as CSSColorMode, p as parseMode, c as colorEqual, i as isValidHex, a as isLonghandHex, r as rgbToHex, h as hexToRGB, b as hexChar } from './utils-f2b09093.js';
import { g as getKey } from './key-477fdfc4.js';
import { d as debounce, i as isObject } from './debounce-4dee3b1c.js';
...
const CalciteColor = class {
  constructor(hostRef) {
    ...
    this.renderChannel = (value, index, label, ariaLabel) => (h("calcite-input", { "aria-label": ariaLabel, class: CSS.channel, "data-channel-index": index, numberButtonType: "none", onChange: this.handleChannelChange, onInput: this.handleChannelInput, onKeyDown: this.handleChannelKeyUpOrDown, onKeyUp: this.handleChannelKeyUpOrDown, prefixText: label, scale: "s", type: "number", value: value.toString() }));
    this.deleteColor = () => {
...
const CalciteColorHexInput = class {
  ...
  render() {
    ...
    const elementDir = getElementDir(el);
    return (h("div", { class: CSS$1.container }, h("calcite-input", { "aria-label": intlHex, class: CSS$1.input, dir: elementDir, onCalciteInputBlur: this.onCalciteInputBlur, onChange: this.onInputChange, onKeyDown: this.onInputKeyDown, prefixText: "#", ref: (node) => (this.inputNode = node), scale: "s", value: hexInputValue }), h("calcite-color-swatch", { active: true, class: CSS$1.preview, color: `#${hexInputValue}`, scale: "s" })));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
export { CalciteColor as calcite_color, CalciteColorHexInput as calcite_color_hex_input, CalciteColorSwatch as calcite_color_swatch };
