...
const defaultColor = utils.normalizeHex(DEFAULT_COLOR.hex());
const CalciteColor = class {
  constructor(hostRef) {
    ...
    this.handleHexInputChange = (event) => {
      ...
      if (hex !== utils.normalizeHex(color$1.hex())) {
    ...
    this.handleChannelKeyUpOrDown = ({ key: key$1, shiftKey }) => {
      key$1 = key.getKey(key$1);
    ...
    this.renderChannel = (value, index$1, label, ariaLabel) => (index.h("calcite-input", { "aria-label": ariaLabel, class: CSS.channel, "data-channel-index": index$1, numberButtonType: "none", onChange: this.handleChannelChange, onInput: this.handleChannelInput, onKeyDown: this.handleChannelKeyUpOrDown, onKeyUp: this.handleChannelKeyUpOrDown, prefixText: label, scale: "s", type: "number", value: value.toString() }));
    this.deleteColor = () => {
  ...
  render() {
    ...
    return (index.h("div", { class: CSS.container }, index.h("canvas", { class: {
      ...
      } }, intlHex), index.h("calcite-color-hex-input", { class: CSS.control, dir: elementDir, onCalciteColorHexInputChange: this.handleHexInputChange, ref: (node) => (this.hexInputNode = node), scale: hexInputScale, theme: theme, value: selectedColorInHex }))), hideChannels ? null : (index.h("calcite-tabs", { class: {
        [CSS.colorModeContainer]: true,
        [CSS.splitSection]: true
      }, dir: elementDir }, index.h("calcite-tab-nav", { slot: "tab-nav" }, this.renderChannelsTabTitle("rgb"), this.renderChannelsTabTitle("hsv")), this.renderChannelsTab("rgb"), this.renderChannelsTab("hsv"))))), hideSaved ? null : (index.h("div", { class: { [CSS.savedColorsSection]: true, [CSS.section]: true } }, index.h("div", { class: CSS.header }, index.h("label", null, intlSaved), index.h("div", { class: CSS.savedColorsButtons }, index.h("calcite-button", { appearance: "transparent", "aria-label": intlDeleteColor, class: CSS.deleteColor, color: "dark", iconStart: "minus", onClick: this.deleteColor, scale: scale, theme: theme }), index.h("calcite-button", { appearance: "transparent", "aria-label": intlSaveColor, class: CSS.saveColor, color: "dark", iconStart: "plus", onClick: this.saveColor, scale: scale, theme: theme }))), savedColors.length > 0 ? (index.h("div", { class: CSS.savedColors }, [
      ...savedColors.map((color) => (index.h("calcite-color-swatch", { active: selectedColorInHex === color, class: CSS.savedColor, color: color, key: color, onClick: this.handleSavedColorSelect, onKeyDown: this.handleSavedColorKeyDown, scale: scale, tabIndex: 0, theme: theme })))
    ])) : null))));
  }
  // --------------------------------------------------------------------------
  //
...
const CalciteColorHexInput = class {
  constructor(hostRef) {
    ...
    this.onInputKeyDown = (event) => {
      ...
      if (key$1 === "ArrowDown" || key$1 === "ArrowUp") {
        const direction = key$1 === "ArrowUp" ? 1 : -1;
        const bump = shiftKey ? 10 : 1;
        this.value = utils.normalizeHex(this.nudgeRGBChannels(this.internalColor, bump * direction).hex());
        event.preventDefault();
        return;
      }
  ...
  render() {
    ...
    const elementDir = dom.getElementDir(el);
    return (index.h("div", { class: CSS$1.container }, index.h("calcite-input", { "aria-label": intlHex, class: CSS$1.input, dir: elementDir, onCalciteInputBlur: this.onCalciteInputBlur, onChange: this.onInputChange, onKeyDown: this.onInputKeyDown, prefixText: "#", ref: (node) => (this.inputNode = node), scale: "s", value: hexInputValue }), index.h("calcite-color-swatch", { active: true, class: CSS$1.preview, color: `#${hexInputValue}`, scale: "s" })));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
const calciteColorSwatchCss = "@-webkit-keyframes calcite-fade-in{0%{opacity:0}100%{opacity:1}}@keyframes calcite-fade-in{0%{opacity:0}100%{opacity:1}}@-webkit-keyframes calcite-fade-in-down{0%{opacity:0;-webkit-transform:translate3D(0, -5px, 0);transform:translate3D(0, -5px, 0)}100%{opacity:1;-webkit-transform:translate3D(0, 0, 0);transform:translate3D(0, 0, 0)}}@keyframes calcite-fade-in-down{0%{opacity:0;-webkit-transform:translate3D(0, -5px, 0);transform:translate3D(0, -5px, 0)}100%{opacity:1;-webkit-transform:translate3D(0, 0, 0);transform:translate3D(0, 0, 0)}}@-webkit-keyframes calcite-fade-in-up{0%{opacity:0;-webkit-transform:translate3D(0, 5px, 0);transform:translate3D(0, 5px, 0)}100%{opacity:1;-webkit-transform:translate3D(0, 0, 0);transform:translate3D(0, 0, 0)}}@keyframes calcite-fade-in-up{0%{opacity:0;-webkit-transform:translate3D(0, 5px, 0);transform:translate3D(0, 5px, 0)}100%{opacity:1;-webkit-transform:translate3D(0, 0, 0);transform:translate3D(0, 0, 0)}}@-webkit-keyframes calcite-fade-in-scale{0%{opacity:0;-webkit-transform:scale3D(0.95, 0.95, 1);transform:scale3D(0.95, 0.95, 1)}100%{opacity:1;-webkit-transform:scale3D(1, 1, 1);transform:scale3D(1, 1, 1)}}@keyframes calcite-fade-in-scale{0%{opacity:0;-webkit-transform:scale3D(0.95, 0.95, 1);transform:scale3D(0.95, 0.95, 1)}100%{opacity:1;-webkit-transform:scale3D(1, 1, 1);transform:scale3D(1, 1, 1)}}:root{--calcite-popper-transition:150ms ease-in-out}:host([hidden]){display:none}:host{display:-ms-inline-flexbox;display:inline-flex}:host([scale=s]){height:20px;width:20px}:host([scale=m]){height:24px;width:24px}:host([scale=l]){height:28px;width:28px}.swatch{height:inherit;width:inherit;overflow:visible}.swatch rect{-webkit-transition:all 150ms ease-in-out;transition:all 150ms ease-in-out}";
